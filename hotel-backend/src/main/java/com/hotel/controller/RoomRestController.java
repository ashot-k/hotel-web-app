...
public class RoomRestController {
    ...
    @PostMapping("/image")
    public ResponseEntity<String> uploadRoomImage(@RequestPart("image") MultipartFile imageFile, @RequestPart("roomName") String roomName) {
        roomService.saveRoomImage(imageFile, roomName);
        return new ResponseEntity<>("Image Saved for room: " + roomName, HttpStatus.OK);
    }
