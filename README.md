...
| DELETE | /api/users/:id    | -                      | Delete user             | DELETE /api/users/123                        |
# GET Users paged
...
```
# DELETE User
### Request ```curl -X DELETE --location "http://localhost/api/users/:id"```
### Example response for request `DELETE /api/users/123`
...
| Method | URL                        | Params                 | Action                      | Example Request                              |
|--------|----------------------------|------------------------|-----------------------------|----------------------------------------------|
| GET    | /api/rooms                 | pageNo, pageSize       | Get rooms paged             | GET /api/rooms?pageNo=0&pageSize=1           |
| GET    | /api/rooms/:id             | -                      | Get room by id              | GET /api/rooms/123                           |
| GET    | /api/rooms/search          | term, pageNo, pageSize | Get rooms by term paged     | GET /api/rooms/search?term=single&pageSize=2 |
| GET    | /api/rooms/room-types      | -                      | Get all room types          | GET /api/rooms/room-types                    |
| GET    | /api/rooms/image/:roomName | -                      | Get room image by room name | GET /api/rooms/image/1                       |
| POST   | /api/rooms                 | -                      | Create room                 | POST /api/rooms + json body                  |
| PUT    | /api/rooms/:id             | -                      | Update room                 | PUT /api/rooms/123 + json body               |
| DELETE | /api/rooms/:id             | -                      | Delete room                 | DELETE /api/rooms/123                        |

## Reservations
| Method | URL                         | Params                 | Action                                                         | Example Request                                                 |
|--------|-----------------------------|------------------------|----------------------------------------------------------------|-----------------------------------------------------------------|
| GET    | /api/reservations           | pageNo, pageSize       | Get reservations paged                                         | GET /api/reservations?pageNo=0&pageSize=1                       |
| GET    | /api/reservations/:id       | -                      | Get reservation by id                                          | GET /api/reservations/123                                       |
| GET    | /api/reservations/search    | term, pageNo, pageSize | Get reservations by term paged                                 | GET /api/reservations/search?term=single&pageSize=2             |
| GET    | /api/reservations/available | start, end             | Get available rooms within date range (date format YYYY-MM-DD) | GET /api/reservations/available?start=2024-02-08&end=2024-02-23 |
| POST   | /api/reservations           | -                      | Create reservation                                             | POST /api/reservations + json body                              |
| PUT    | /api/reservations/:id       | -                      | Update reservation                                             | PUT /api/reservations/123 + json body                           |
| DELETE | /api/reservations/:id       | -                      | Delete reservation                                             | DELETE /api/reservations/123                                    |
